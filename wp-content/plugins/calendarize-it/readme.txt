...
Version 4.2.9.72240 - July 26, 2016
...
* Fixed Bug: Problem with Date picker when using Spanish date format j \d\e F \d\e Y.
* Fixed Bug: Problem with Time picker when using French G \h i \m\i\n or German Time format G:i \U\h\r
* Fixed Bug: When excluding dates from recurring pattern
* Update: Prevent users from being able to type Date and Time manually. Can only be picked using the Date and Time picker.
...
Version 4.1.4.69604 - April 21, 2016
