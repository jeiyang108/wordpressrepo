...
Description: Calendarize it! The most flexible and feature-rich calendar solution available for WordPress (Now with support for Visual Composer)
Version: 4.3.5.74453
Author: Alberto Lau (RightHere LLC)
Author URI: http://plugins.righthere.com
 **/
 
define('RHC_VERSION','4.3.5'); 
